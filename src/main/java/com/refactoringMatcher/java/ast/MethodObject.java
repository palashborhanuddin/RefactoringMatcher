...
//import com.refactoringMatcher.java.ast.association.Association;
...
public class MethodObject implements AbstractMethodDeclaration {
    ...
    private boolean equalParameterTypes(List<TypeObject> list1, List<TypeObject> list2) {
    	...
    	for(int i=0; i<list1.size(); i++) {
    		...
    		if(type1.getArrayDimension() != type2.getArrayDimension() && type1.getQualifiedClassType().length() != 1 && type2.getQualifiedClassType().length() != 1)
    			return false;
    	}
    	return true;
    }
