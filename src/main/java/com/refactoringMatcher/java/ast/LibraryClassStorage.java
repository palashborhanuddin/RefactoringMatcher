		...
		if(iClassFileList.contains(classFile)) {
			...
			try {
				if(!unMatchedClassFiles.contains(classFile)) {
					...
					int maximumCacheSize = 10;//store.getInt(PreferenceConstants.P_LIBRARY_COMPILATION_UNIT_CACHE_SIZE);
					System.out.println("[TODO PDGCFG] maximumCacheSize set as constant 10");
