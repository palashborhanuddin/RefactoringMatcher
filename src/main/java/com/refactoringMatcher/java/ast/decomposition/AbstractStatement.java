...
public abstract class AbstractStatement extends AbstractMethodFragment {
	...
	public AbstractStatement(Statement statement, List<ParameterObject> parameters, List<ImportObject> importObjectList, Set<Tuple3<String, String, String>> jarSet, StatementType type, AbstractMethodFragment parent) {
		super(parent, parameters, importObjectList, jarSet);
		this.type = type;
